	...
	def load_csq(self,ann_file=None,changes=False,use_genomic=True,use_gene=True):
		...
		for line in tqdm(subprocess.Popen(cmd,shell=True,stdout=subprocess.PIPE).stdout):
			...
			for i in range(4,len(row)-2,3):
				...
				gene = info[1]
				if info[0]=="missense&inframe_altering" or info[0]=="missense" or info[0]=="*missense" or info[0]=="start_lost" or info[0]=="*start_lost" or info[0]=="*stop_lost" or info[0]=="stop_lost" or info[0]=="stop_gained" or info[0]=="*stop_gained":
				...
				elif info[0]=="inframe_insertion" or info[0]=="inframe_deletion" or info[0]=="frameshift" or info[0]=="*frameshift" or info[0]=="synonymous" or info[0]=="*synonymous" or info[0]=="stop_retained":
